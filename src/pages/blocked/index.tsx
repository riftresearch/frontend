...
interface BlockedPageProps extends PropsWithChildren {}
...
const BlockedPage: React.FC<BlockedPageProps> = () => {
    ...
    return (
        <Flex h='100vh' width='100%' direction='column' backgroundImage={'/images/rift_background_low.webp'} backgroundSize='cover' backgroundPosition='center'>
            <Navbar />
            <Flex direction={'column'} align='center' w='100%' mt={'18vh'}>
                <RiftSVG />
                <Flex
                    userSelect={'none'}
                    cursor={'default'}
                ...
                <Flex
                    ...
                    <Text>
                        <OrangeText>Bitcoin</OrangeText> and <BlueText>Ethereum</BlueText>
                    </Text>
                </Flex>
                <Flex align={'center'} justify={'center'} w='100%' mt='30px' px='20px' direction={'column'} overflow={'visible'}>
                    <Flex
                        ...
                        <Flex w='90%' direction={'column'} align='center'>
                            <Text fontFamily={FONT_FAMILIES.NOSTROMO} fontSize={28} textAlign='center' mb='20px'>
                                This product is not available in your region
                            </Text>
                            <Text fontFamily={FONT_FAMILIES.AUX_MONO} fontWeight='300' textAlign='center'>
                                We're sorry, but access to Rift is restricted in your country.
                            </Text>
                        </Flex>
                    </Flex>
                </Flex>

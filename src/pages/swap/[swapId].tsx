...
// Map SDK status to deposit flow state
...
export default function SwapPage() {
  ...
  const [previousState, setPreviousState] = React.useState<string>("not_started");
  ...
  React.useEffect(() => {
    ...
    if (previousState === "not_started") {
      ...
      } else if (depositFlowState !== "not_started") {
  ...
  // For BTC deposits, the deposit address comes from the store (set during swap creation)
  const bitcoinDepositAddress = swapResponse?.deposit_vault_address;
      ...
      >
        ...
        <Flex justify="center" align="center" direction="column" minH="calc(100vh - 80px)" p="4">
          <UnifiedTransactionWidget
            ...
            bitcoinDepositTx={swapStatusInfo?.depositTransaction}
          />
        </Flex>

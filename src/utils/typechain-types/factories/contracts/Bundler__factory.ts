...
export class Bundler__factory extends ContractFactory {
  ...
  override deploy(
    _swapRouter: string,
    _riftExchange: string,
    _cbBTC: string,
    _permit2: string,
    _universalRouter: string,
  ...
  override attach(address: string): Bundler {
    return super.attach(address) as Bundler;
  }
  override connect(signer: Signer): Bundler__factory {
    return super.connect(signer) as Bundler__factory;
  }

...
export class SP1MockVerifier__factory extends ContractFactory {
  ...
  ): Promise<SP1MockVerifier> {
    return super.deploy(overrides || {}) as Promise<SP1MockVerifier>;
  }
  ...
  override attach(address: string): SP1MockVerifier {
    return super.attach(address) as SP1MockVerifier;
  }
  override connect(signer: Signer): SP1MockVerifier__factory {
    return super.connect(signer) as SP1MockVerifier__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SP1MockVerifierInterface {
    return new utils.Interface(_abi) as SP1MockVerifierInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SP1MockVerifier {
    return new Contract(address, _abi, signerOrProvider) as SP1MockVerifier;
  }
}

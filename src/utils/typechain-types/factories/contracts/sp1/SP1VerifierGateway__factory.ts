...
export class SP1VerifierGateway__factory extends ContractFactory {
  ...
  ): Promise<SP1VerifierGateway> {
    return super.deploy(
      initialOwner,
      overrides || {}
    ) as Promise<SP1VerifierGateway>;
  }
  ...
  override attach(address: string): SP1VerifierGateway {
    return super.attach(address) as SP1VerifierGateway;
  }
  override connect(signer: Signer): SP1VerifierGateway__factory {
    return super.connect(signer) as SP1VerifierGateway__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SP1VerifierGatewayInterface {
    return new utils.Interface(_abi) as SP1VerifierGatewayInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SP1VerifierGateway {
    return new Contract(address, _abi, signerOrProvider) as SP1VerifierGateway;
  }
}
